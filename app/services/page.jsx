      ...
      pages_faq_details: [
        {
          ...
          answer: "<p>No referral is needed. You can directly book an appointment for any of our services, including screenings and specialist consultations.<br></p>",
        },
        {
          id: 8,
          question: "How often should I get my eyes checked?",
          answer: "<p>We recommend annual check-ups, especially if you have diabetes, wear glasses, or are over 40.</p>",
        },
        {
          id: 9,
          question: "What types of surgeries are performed at the clinic?",
          answer: "<p>We offer cataract surgery, corneal grafts, glaucoma procedures, oculoplastic and orbital surgeries, all performed using advanced techniques.</p>",
        },
        {
          id: 10,
          question: "Is laser treatment painful?",
          answer: "<p>Most laser eye treatments are quick and cause little to no discomfort. Numbing drops are used for comfort during the procedure.</p>",
        },
        {
          id: 11,
          question: "What insurance or payment options are accepted?",
          answer: "<p>We accept a variety of insurance plans and also offer flexible payment options. Our staff can guide you based on your specific coverage.</p>",
        },
      ]
    }
  ];
