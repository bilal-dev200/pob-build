...
const blogId = pathname.split("/").filter(Boolean).pop(); 
    ...
    useEffect(() => {
      ...
      const fetchBlogDetails = async () => {
        setLoading(true);
        try {
          const res = await axios.public.post("/blogs/detail", {
            blog_slug: `${blogId}/`
      ...
      <div className="pt-20 md:pt-32">
        ...
        <div className="px-5 md:px-10 py-6 md:py-8 flex flex-col md:flex-row gap-6">
          ...
          <div className="hidden lg:flex lg:w-[20%] flex-col gap-5">
            <h2 className="text-lg mb-4 font-montserrat text-black">
              Categories
            </h2>
          ...
          <div className="md:w-[65%]">
            <h1 className="text-4xl font-newsLetter mb-6">
              {blog?.blog_title}
            </h1>
            <div
