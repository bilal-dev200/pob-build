  ...
  return (
    <section className="flex flex-col-reverse md:flex-row justify-center items-center gap-10 px-6 md:px-20 py-12">
      ...
      <div className="md:w-1/2 text-center md:text-start">
        ...
        {isClient && DOMPurify && description && (
          <div
        ...
        {isClient && DOMPurify && description2 && (
          <div
            className="text-gray-600 mt-4 font-inter"
            dangerouslySetInnerHTML={{
        ...
        <Link href="/contact-us/">
          <button className="mt-2 px-4 py-2 bg-green-500 text-white text-[12px] rounded-full hover:bg-green-600 transition cursor-pointer">
            {buttonText}
          </button>
        </Link>
      </div>
