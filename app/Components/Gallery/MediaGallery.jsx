      ...
      <div className="w-full max-w-[95%] mx-auto flex flex-col md:flex-row gap-6 items-start md:items-center px-4 sm:px-6 md:px-12 lg:px-24">
        ...
        <div className="flex-1 min-w-0 text-center md:text-left">
          <div className="">
            ...
            <Link href="/gallery/">
              <button className="my-5 border border-black text-black px-6 py-2 rounded-full hover:bg-black hover:text-white transition">
                View All
              </button>
            </Link>
          </div>
          ...
          <div className=" mt-6 md:mt-2">
            {imageGalleryImages && imageGalleryImages.length > 0 && (
              <img
                ...
                className="w-[343px] h-[250px] sm:h-[280px] sm:w-[370px] object-cover rounded-xl"
              />
            )}
          </div>
        </div>
